...
sub content {
    ...
    if ($self->isFailure) {
        carp 'Fetching content from a failed InteraxiomApi::Response Object';
        return;
    }
...
InteraxiomApi::Answer - Response to a request run with C<InteraxiomApi>.
...
This module represents a response to a query run with C<InteraxiomApi>. It is build upon a C<HTTP::Request> object.
